...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ltf6ehy.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ltf6ehy.containers.anotherwebservice.com/
...
```
git clone git@github.com:ethuo2009/container-ltf6ehy.git
cd container-ltf6ehy
```
...
```
docker attach container-ltf6ehy
```
